...
ArraStack.py: It will implement the interface Stack in lab 1
ArraQueue.py: It will implement the interface Queue in lab 1
ArraList.py: It will implement the interface List in lab 1
